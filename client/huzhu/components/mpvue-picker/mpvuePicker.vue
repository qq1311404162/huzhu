<template>
    <view class="mpvue-picker">
        ...
        <view class="mpvue-picker-content " :class="{'mpvue-picker-view-show':showPicker}">
            ...
            <!-- 单列 -->
            <picker-view indicator-style="height: 40upx;" class="mpvue-picker-view" :value="pickerValue" @change="pickerChange" v-if="mode==='selector' && pickerValueSingleArray.length > 0">
                <block>
                    <picker-view-column>
            ...
            <!-- 时间选择器 -->
            <picker-view indicator-style="height: 40upx;" class="mpvue-picker-view" :value="pickerValue" @change="pickerChange" v-if="mode==='timeSelector'">
                <block>
                    <picker-view-column>
            ...
            <!-- 多列选择 -->
            <picker-view indicator-style="height: 40upx;" class="mpvue-picker-view" :value="pickerValue" @change="pickerChange" v-if="mode==='multiSelector'">
            ...
            <!-- 二级联动 -->
            <picker-view indicator-style="height: 40upx;" class="mpvue-picker-view" :value="pickerValue" @change="pickerChangeMul" v-if="mode==='multiLinkageSelector' && deepLength===2">
                <block>
                    <picker-view-column>
            ...
            <!-- 三级联动 -->
            <picker-view indicator-style="height: 40upx;" class="mpvue-picker-view" :value="pickerValue" @change="pickerChangeMul" v-if="mode==='multiLinkageSelector' && deepLength===3">
                <block>
                    <picker-view-column>
